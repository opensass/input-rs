...
pub fn login_form_two() -> Html {
    ...
    html! {
        <section
            class="bg-gradient-to-r from-pink-600 via-orange-500 to-yellow-300 min-h-screen items-center justify-center text-white"
        >
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/3">
                      ...
                      "
                            ...
                            <form action="#" class="mt-6" onsubmit={onsubmit}>
                                if !error.is_empty() {
                                    <div
                                        class="bg-red-600 text-white py-3 font-bold rounded-md text-center mb-4 text-lg"
                                    >
                                        { error }
                                    </div>
                                }
                                ...
                                if !email_valid {
                                    <div class="error-txt text-red-500 text-sm mb-5">
